            ...
            <div className="hidden lg:flex items-center flex-shrink-0 ">
              {status === "loading" ? null : session ? (
                ...
                <div className="inline-flex items-center">
                  <Link
                    href="/auth/signin"
                    className="font-body inline-block px-6 py-2.5 bg-white text-red-700 font-medium text-xs leading-tight uppercase rounded shadow-lg hover:bg-slate-200 hover:shadow-lg focus:bg-slate-200 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-slate-200 active:shadow-lg transition duration-150 ease-in-out"
                  >
                    Sign In
                  </Link>
                </div>
