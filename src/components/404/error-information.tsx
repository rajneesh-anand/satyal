...
const ErrorInformation: React.FC = () => {
  ...
  const backgroundThumbnail = "/images/bg.png";
  const errorThumbnail = "/images/404.svg";
  return (
    <div
      className="text-center px-12 pb-16 pt-8 sm:py-20 lg:py-16 xl:py-20 flex items-center justify-center bg-cover bg-no-repeat bg-center"
      style={{
