             ...
             <div className=" px-3 sm:px-[30px] lg:px-[50px] my-2 py-2 flex justify-between items-center ">
               <div className=" w-[80px] sm:w-[200px] h-[80px] sm:h-[100px] mr-3 sm:mr-0 border border-solid border-black"></div>
                <div className="w-5/6 sm:w-3/6 lg:w-2/6 flex justify-between">
                  <Button onClick={()=>handelModalComponent('WORKSHIRT_COMPONENT')} type={ButtonType.Secondary} size={ButtonSize.Large} className="">WORKSHEET</Button>
                <a href='/' className='bg-dark-footer text-white  hover:bg-white hover:text-dark-footer border-2 border-solid border-dark-footer text-md font-bold  py-1 sm:py-2 rounded-lg transition-all duration-300  ease-in-out hover:transition-all  px-3 sm:px-4' target='blank'>JOIN CLASS</a>
                </div>
             </div>
